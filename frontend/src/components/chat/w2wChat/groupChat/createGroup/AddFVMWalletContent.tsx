...
export const AddFVMWalletContent = ({
  onSubmit,
  memberList,
  handleMemberList,
  isLoading,
      ...
      <Container>
        <SearchbarContainer>
          <LabelContainer>
            ...
            >
              {groupMembers
                ? `0${memberList?.length + groupMembers?.length} / 08 Members`
                : `0${memberList?.length} / 08 Members`}
            </SpanV2>
          </LabelContainer>
        ...
        <ModalConfirmButton
          text={groupMembers ? 'Add To DataDAO' : 'Create DataDAO'}
          onClick={() => onSubmit()}
          isLoading={isLoading}
          loaderTitle={groupMembers ? 'Adding DataDao Members' : 'Creating DataDao'}
